...
Напишите программу, имеющую 3 потока, увеличивающих значение
разделяемой переменной. Первый поток увеличивает значение на 1,
второй на 2, третий на 3. Проверьте, что при нескольких запусках
программы могут возникать ошибки в работе.
*/